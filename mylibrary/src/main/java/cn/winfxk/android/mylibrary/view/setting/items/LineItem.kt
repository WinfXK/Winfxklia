...
class LineItem(title: String) : BaseTitleItem(title, empGet, empSet) {
    override val view: View by lazy { View.inflate(context, R.layout.winfxklia_basesettings_item_line, null) }
